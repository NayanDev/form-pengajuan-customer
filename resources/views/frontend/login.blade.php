            ...
            <div class="card my-5">
                <div class="card-body">
                    ...
                    <a href="#" class="d-flex justify-content-center">
                        <img src="{{asset('easyadmin/idev/img/logo-idev.png')}}" class="img-responsive" style="width:350px;">
                    </a>
                    <div class="row">
                    ...
                    <form id="form-login" action="{{url('login')}}" method="post">
                        ...
                        <div class="d-grid mt-4">
                            <button type="button" class="btn btn-outline-warning" id="btn-for-form-login" onclick="submitAfterValid('form-login', '-login')">Sign In</button>
                        </div>
                    </form>
                </div>
            </div>
