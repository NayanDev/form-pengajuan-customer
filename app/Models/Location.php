...
class Location extends Model
{
    ...
    protected $appends = ['btn_delete', 'btn_edit', 'btn_show', 'btn_qrcode'];
    ...
    public function getBtnQrcodeAttribute()
    {
        $html = "<a type='button' class='btn btn-outline-primary btn-sm radius-6' style='margin:1px;' target='_blank' href='" . route('location.export-pdf-default', ['code' => $this->code]) . "'>
