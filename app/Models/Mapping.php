...
class Mapping extends Model
{
    ...
    protected $table = 'mapping_study_points';
    protected $primaryKey = 'id';
    protected $fillable = ["mapping_study_id","location_id"];
    ...
    {
        return $this->hasMany(MappingStudyReading::class, 'mapping_study_point_id', 'id');
    }


    public function getBtnPrintAttribute()
    {
        $html = "<a href='" . url('mapping-suhu') . "?mapping_study=" . $this->id ."&category=mapping' target='_blank' class='btn btn-outline-primary btn-sm radius-6' style='margin:1px;'>
                    <i class='ti ti-eye'></i>
                </a>";
