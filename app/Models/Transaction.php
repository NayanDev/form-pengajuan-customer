...
class Transaction extends Model
{
    ...
    protected $fillable = ["nik","asset_id","assigned_date","return_date","notes","is_active"];
    protected $appends = ['btn_delete', 'btn_edit', 'btn_show', 'data_asset'];
    ...
    public function getDataAssetAttribute()
    {
        $category = Asset::where('id', $this->asset_id)->first();
        return $category ? ($category->code . ' - ' . $category->category . ' - ' . $category->merk . ' - ' . $category->model) : '-';
    }
